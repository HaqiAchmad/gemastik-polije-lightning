 ...
 * @since 27 July 2021
 */
public class CetakLaporanSpp extends javax.swing.JDialog {

    private final String idPembayaran;
    
    public CetakLaporanSpp(java.awt.Frame parent, boolean modal, String idPembayaran) {
        super(parent, modal);
...
//        this.setResizable(false);
        this.setTitle(this.idPembayaran + " ~ Cetak Laporan SPP");
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(CetakLaporanSpp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                CetakLaporanSpp dialog = new CetakLaporanSpp(new javax.swing.JFrame(), true, "TR000111");
