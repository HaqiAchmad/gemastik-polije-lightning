...
public class EditDataPetugas extends javax.swing.JDialog {
    ...
    public EditDataPetugas(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        this.parent = parent;
        this.modal = modal;
        this.id = id;
    ...
    private void showData(){
        ...
        this.setTitle(this.nama + " ~ Edit Data Petugas");
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        this.dispose();
        Audio.play(Audio.SOUND_INFO);
        new EditDataPetugas(this.parent, this.modal, this.id).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                EditDataPetugas dialog = new EditDataPetugas(new javax.swing.JFrame(), true, "11");
