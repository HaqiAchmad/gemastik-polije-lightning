 ...
 * @since 2021-03-24
 */
public class EditDataSiswa extends javax.swing.JDialog {
    ...
    public EditDataSiswa(java.awt.Frame parent, boolean modal, String nis) {
        super(parent, modal);
        this.parent = parent;
        this.modal = modal;
        initComponents();
...
//        this.setSize(955, 590);
    ...
    private void showData() {
        ...
        this.kelas = siswa.getIdKelas(nis);
        ...
        this.setTitle(namaSiswa + " ~ Edit Data Siswa");
        ...
        this.inpKelas.setSelectedItem(this.kelas);
        this.inpSpp.setSelectedItem(this.idSpp);
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        this.dispose();
        Audio.play(Audio.SOUND_INFO);
        new EditDataSiswa(this.parent, this.modal, this.nis).setVisible(true);
    ...
    private void inpNisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_inpNisMouseClicked
        Message.showWarning(this, "NIS dari Siswa tidak diperbolehkan untuk diedit!");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                EditDataSiswa dialog = new EditDataSiswa(new javax.swing.JFrame(), true, "6156");
