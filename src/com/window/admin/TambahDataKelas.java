 ...
 * @author 16 Juli 2021
 */
public class TambahDataKelas extends javax.swing.JDialog {

    public TambahDataKelas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTop.setText("Tambah Data Kelas");
        ...
        inpLevel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pilih Kelas", "X (Sepuluh)", "XI (Sebelas)", "XII (Duabelas)", "XIII (Tigabelas)" }));

        inpJurusan.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        inpJurusan.setForeground(new java.awt.Color(0, 0, 0));
        inpJurusan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pilih Jurusan", "Teknik Pemesinan", "Teknik Instalasi Tenaga Listrik", "Teknik Otomasi Industri", "Tata Boga", "Tata Busana", "Rekayasa Perangkat Lunak", "SMA (IPA)", "SMA (IPS)", "SMA (Bahasa)" }));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        Log.addLog("Membuka Window TambahDataKelas.");
    }//GEN-LAST:event_formWindowOpened

    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        Log.addLog("Menutup Window TambahDataKelas.");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                TambahDataKelas dialog = new TambahDataKelas(new javax.swing.JFrame(), true);
