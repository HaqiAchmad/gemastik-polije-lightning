 ...
 * @since 2021-07-27
 */
public class EditAkunPetugas extends javax.swing.JDialog {
    ...
    private String nama, gender, tempatLahir, tanggalLahir, alamat, nohp, email, password, level;
    private File foto, newFoto;
    
    public EditAkunPetugas(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        this.parent = parent;
        this.modal = modal;
        this.id = id;
    ...
    private void showData(){
        // mendapatkan data-data dari petugas yang akan diedit
        this.nama = txt.toCapitalize(petugas.getNama(id));
        this.gender = txt.getGenderName(petugas.getGender(id));
        this.tempatLahir = txt.toCapitalize(petugas.getTempatLahir(id));
        this.tanggalLahir = txt.toCapitalize(petugas.getTanggalLahir(id));
        this.alamat = txt.toCapitalize(petugas.getAlamat(id));
        this.nohp = petugas.getNoHp(id);
        this.email = petugas.getEmail(id);
        this.password = txt.toPasswordCase(petugas.getPassword(id));
        this.level = txt.toCapitalize(petugas.getLevel(id).name());
        this.foto = new File(petugas.getPhoto(id, UserPhotoSize.EDIT_FOTO_PETUGAS).toString());
        
        // menampilkan data-data dari petugas
        this.setTitle(this.nama + " ~ Edit Akun");
    ...
    private void initComponents() {
        ...
        inpLevel = new javax.swing.JTextField();
        ...
        inpID.setBackground(new java.awt.Color(204, 204, 204));
        ...
        inpLevel.setBackground(new java.awt.Color(204, 204, 204));
        inpLevel.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        inpLevel.setForeground(new java.awt.Color(0, 0, 0));
        inpLevel.setCaretColor(new java.awt.Color(10, 79, 223));
        inpLevel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                inpLevelMouseClicked(evt);
            }
        });
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlMainLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(pnlMainLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(inpLevel, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(pnlMainLayout.createSequentialGroup()
                ...
                .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlMainLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(inpLevel, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void showFotoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_showFotoMouseClicked
        ...
        // jika user tidak megedit foto maka foto yang akan ditampilkan adalah foto yang lama
            ...
            new PenampilFotoPetugas(this.parent, this.modal, petugas.getPhoto(this.id, UserPhotoSize.SHOW_FOTO_PETUGAS)).setVisible(true);
        }
        // jika user mengedit foto
        else{
            // menampilkan foto yang dipilh oleh user
            Audio.play(Audio.SOUND_INFO);
            new PenampilFotoPetugas(this.parent, this.modal, Gambar.scaleImage(this.newFoto, 359, 323)).setVisible(true);
        }
    ...
    private void lblEditFotoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEditFotoMouseClicked
        ...
        if(this.newFoto != null){
            ...
            this.showFoto.setIcon(Gambar.scaleImage(this.newFoto, 76, 78));
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        Log.addLog("Membuka Window EditAkunPetugas");
    ...
    private void btnUbahPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahPasswordActionPerformed
        Audio.play(Audio.SOUND_INFO);
        new ChangePassword(this.parent, this.modal, this.id).setVisible(true);
    ...
    private void inpIDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_inpIDMouseClicked
        Message.showWarning(this, "ID Petugas tidak diperbolehkan untuk diedit!");
    }//GEN-LAST:event_inpIDMouseClicked

    private void inpLevelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_inpLevelMouseClicked
        if(this.petugas.isAdmin()){
            Message.showWarning(this, "Untuk mengedit Level dari akun silahkan pergi ke Window Data Petugas.");
        }else{
            Message.showWarning(this, "Anda tidak diperbolehkan untuk mengedit Level.");
        }
    }//GEN-LAST:event_inpLevelMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAkunPetugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                EditAkunPetugas dialog = new EditAkunPetugas(new javax.swing.JFrame(), true, "11");
