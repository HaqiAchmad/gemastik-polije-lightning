...
public class TentangAplikasi extends javax.swing.JFrame {
    ...
    private final String name, namaApp, versiApp, ukuranApp, dirilis, diupdate, bahasaProgram, dbPlatform, tahunAjaran, pengguna, 
    ...
    public TentangAplikasi() {
        ...
        name = new Text().toCapitalize(petugas.getNama());
        ...
        this.pengguna = txt.addDelim(petugas.getTotalUser());
